...
class Easylink extends StatefulWidget {
  Easylink({required Key key, required this.title}) : super(key: key);

  final String title;

  @override
  _EasylinkState createState() => _EasylinkState();
}
