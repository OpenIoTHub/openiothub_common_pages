...
(a)目的 本应用获取用户个人信息是为了软件功能的正常运行，用于鉴别用户，用于用户登录等

(b)方式 本应用收集用户信息由用户本人填写

(c)范围 本应用收集的用户个人信息包括用户手机号和邮箱及设置用于访问本应用的密码

(d)时间 本应用在用户注册，登录时获取这些个人信息

(e)地点 本应用获取的个人信息存储于阿里云杭州服务器MySQL数据库
